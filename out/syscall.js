...
exports.LINUX_SYSCALLS = void 0;
exports.LINUX_SYSCALLS = new Map([
    [0, {
            number: 0,
            name: 'read',
    ...
    [282, {
            number: 282,
            name: 'signalfd',
            description: 'Create a file descriptor that receives signals as read events',
    ...
    [453, {
            ...
            parameters: ['%rdi: unsigned long flags'],
